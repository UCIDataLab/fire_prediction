...
start_date = dt.date(2007, 1, 1)
end_date = dt.date(2016, 12, 31)
luigi.build([GfsFilterRegion(raw_data_dir=os.path.join(data_dir, 'raw/gfs/4/'),
                             interim_filtered_data_dir=os.path.join(data_dir,'interim/gfs/filtered/4/'),
                             interim_aggregated_data_dir=os.path.join(data_dir, 'interim/gfs/aggregated/4'),
                             dest_data_dir=os.path.join(data_dir,'interim/gfs/region/4'), resolution_sel='4',
                             start_date_sel=start_date, end_date_sel=end_date, bounding_box_sel_name='alaska')],
