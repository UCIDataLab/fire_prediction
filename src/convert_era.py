...
def convert_era(src_path, src_path_precip, dest_path):
    ...
    rel_humidity = 100*(np.exp((17.625*temp_dew_c)/(243.04+temp_dew_c))/np.exp((17.625*temp_c)/(243.04+temp_c)))
    ...
    with xr.open_dataset('/lv_scratch/scratch/graffc0/fire_prediction/data/interim/gfs/region/4/gfs_4_alaska_20070101_20161231.nc') as temp_in:
